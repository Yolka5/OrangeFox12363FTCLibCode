...
public class AutoBlueBackStrafe extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        //---------------------------
        TrajectorySequence left = drive.trajectorySequenceBuilder(new Pose2d(12, 63, Math.toRadians(270)))
                .addTemporalMarker(() -> {
...
//                    rightClaw.setPosition(leftClawOpen);
                ...
                .lineToLinearHeading(new Pose2d(30, 38, Math.toRadians(270)))
                .addTemporalMarker(()->{
//                    System.out.println("put on line");
                ...
                .waitSeconds(1)
                .build();
        TrajectorySequence mid = drive.trajectorySequenceBuilder(new Pose2d(12, 63, Math.toRadians(270)))
                .addTemporalMarker(() -> {
                    ang.setTargetPosition(0);
                    ang.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    ang.setPower(0.3);
...
//                    System.out.println("put on line");
        ...
        TrajectorySequence right = drive.trajectorySequenceBuilder(new Pose2d(12, 63, Math.toRadians(270)))
                .addTemporalMarker(() -> {
                    ang.setTargetPosition(0);
                    ang.setMode(DcMotor.RunMode.RUN_TO_POSITION);
                    ang.setPower(0.3);
...
//package org.firstinspires.ftc.teamcode.drive.opmode.Auto.OneTrajectoryStarfe;
//
//
//import com.acmerobotics.dashboard.FtcDashboard;
//import com.acmerobotics.dashboard.telemetry.MultipleTelemetry;
...
//
//import org.firstinspires.ftc.robotcore.external.hardware.camera.WebcamName;
//import org.firstinspires.ftc.teamcode.Vision.BlueBlobDetectionPipeline;
