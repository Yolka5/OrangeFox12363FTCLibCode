...
public class SampleMecanumDrive extends MecanumDrive {
    ...
    public static PIDFCoefficients MOTOR_VELO_PID = new PIDFCoefficients(0, 0, 0, 106);
    public static PIDCoefficients TRANSLATIONAL_PID = new PIDCoefficients(6, 0.2, 0.1);
