...
public class AutoBlueFarSide extends LinearOpMode {
    ...
    BlueBlobDetectionPipeline blueBlobPipeline = new BlueBlobDetectionPipeline();
...
//            telemetry.addData("Distance in Inch", (getDistance(width)));
            telemetry.addData("Rect_Num:", rect);
            telemetry.update();
            rect = blueBlobPipeline.getPropPose();
            if (starting){
                switch (rect){
                    case 0:
...
//        controlHubCam.setPipeline(new BlueBlobDetectionPipeline());
        controlHubCam.setPipeline(blueBlobPipeline);
...
//            Scalar lowerBlue = new Scalar(65, 77, 92);
//            Scalar lowerBlue = new Scalar(88, 92, 51);
            Scalar upperBlue = new Scalar(60, 100, 100);
//            Scalar upperBlue = new Scalar(61, 145, 255);
//            Scalar upperBlue = new Scalar(255, 0, 154);
            Scalar lowerBlue = new Scalar(112, 255, 255);
