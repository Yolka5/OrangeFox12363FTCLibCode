...
public class BlueBlobDetectionPipeline extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat input) {
        ...
        if (largestContour != null) {
            ...
            Rect leftRect = new Rect(20, 150, 400, 450);
            Rect midRect = new Rect(490, 100, 400, 500);
            Rect rightRect = new Rect(950, 150, 400, 450);
...
//                telemetry.addData("rect:","mid rect");
                ...
                Imgproc.rectangle(input, midRect, rectColor, 2);
                Imgproc.rectangle
                (input, rightRect, rightRectColor, 2);
...
//                telemetry.addData("rect:","NO RECT, last rect was" + rect);
            ...
            Imgproc.putText(input, label, new Point(cX + 10, cY), Imgproc.FONT_HERSHEY_COMPLEX, 1, new Scalar(0, 255, 0), 2);
